...
if __name__== "__main__":
    ...
    parser.add_argument('-cal', '--calibrate', action='store', dest='calib', default=True ,
                    help='Path for input video')
    
    parser.add_argument('-img', '--img_path', action='store', dest='img_path', default='./data/img.jpg' ,
                    help='Path for input video')
   ...
   # # set mouse callback 
    ...
    print(calib)
    if calib:
        calibrate("/home/vikram/Documents/TRAKR_AI/birds-eye-view/images/0000.png")
